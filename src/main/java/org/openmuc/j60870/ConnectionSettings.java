...
class ConnectionSettings {
    ...
    private boolean checkSeqNumber;
    ...
    public ConnectionSettings(ConnectionSettings connectionSettings) {
        ...
        this.checkSeqNumber = connectionSettings.checkSeqNumber;
    }

    public boolean isCheckSeqNumber() {
        return this.checkSeqNumber;
    }

    public void setCheckSeqNumber(boolean checkSeqNumber) {
        this.checkSeqNumber = checkSeqNumber;
    }
